...
for(;;){System.out.println("1.Ingresar dato   2.Ver arbol in-order  3.buscar y borrar dato  4.Salir");
	...
	while(s!=1 && s!=2 && s!=3 && s!=4){
        ...
        switch (s){
			...
			if(A.buscar(A.raiz,num)==null){
				System.out.println("No existe el dato");}
			else{
				System.out.println("Dato encontrado, ingresa 1 para borrar o 0 para cancelar");
				s=pedirnum("");
				while(s!=1 && s!=0){
					System.out.println("opción inválida");
					s=pedirnum("");}
				if(s==1){ A.borrar(A.buscar(A.raiz,num));}
				}
			System.out.println("----------"); 
